...
<h5><a href="#log_message">The indent-aware writing method <em>log_message(msg, indent_extra=4)</em></a></h5>
...
The following class `A_meta` will serve as the metaclass for classes defined subsequently:
    ...
    ...         logging_fn = mcs.__prepare__.__func__.log_calls_settings.log_message
    ...
    ...         if A_debug >= A_DBG_INTERNAL:
    ...             logging_fn = mcs.__new__.log_calls_settings.log_message    
    ...
    ...         if A_debug >= A_DBG_INTERNAL:
    ...             logging_fn = self.__class__.__dict__['__init__'].log_message
